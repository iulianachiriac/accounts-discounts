  ...
  function we(e) {
    ...
    const m = [].concat(u, l.contains),
      ...
      y = {
        match: n.concat(
          /\b/,
          ((w = [...fe, "super", "import"]), n.concat("(?!", w.join("|"), ")")),
          t,
          n.lookahead(/\(/)
        ),
        ...
        x = [
          {
            ...
            starts: {
              contains: [
                { begin: /\(/, end: /\)/, keywords: Fe, contains: [...b, h, v] }
              ]
            }
          },
...
"object" == typeof exports &&
  ...
  (module.exports =
    hljs); /*! `apex` grammar compiled for Highlight.js 11.5.0 */
(() => {
  var e = (() => {
    "use strict";
    return (e) => {
      const s = e.regex,
        ...
        p = [
          ...
          { match: [t, s.lookahead(/\s*\[\]/)], scope: { 1: "type" } }
        ],
        E = {
        ...
        A = {
          variants: [
            ...
            {
              begin: [/(?<=\s)/, s.concat("(?:" + t + ")"), /(?=\s*\()/],
              scope: { 2: "title.function" }
            }
          ],
          contains: [r, o, e.APOS_STRING_MODE],
          relevance: 0
        },
        u = {
          begin: /\[[\s\n]*(?=SELECT)/,
          ...
          contains: [
            ...
            { match: /(?<=\bFROM\b\s+)\w+/, scope: "type", relevance: 0 },
            { match: /\b[a-zA-Z][a-zA-Z_0-9]*\b/, scope: "property" },
            a,
            A
          ],
          illegal: "::"
      ...
      return {
        ...
        contains: [
          ...
          A,
          {
            ...
            scope: { 2: "built_in", 4: "property" }
          },
          n,
          a,
          c,
          { match: /(?<!\.)\bId\b/, scope: "type", relevance: 8 },
          u
        ]
      };
    };
